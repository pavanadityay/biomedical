...
gset <- getGEO("GSE124390", GSEMatrix =TRUE, AnnotGPL=FALSE)
...
gsms <- "00000000000XXXXXXXXXXX1111111111"
...
write.csv(bT[c("t", "logFC")],'/Biomed/dataset/healthyleu.csv')

PATH <-"/Biomed/dataset/healthyleu.csv"
df <- read.csv(PATH) %>%
  select(c(t,logFC))
glimpse(df)
...
write.csv(df,'/Biomed/dataset/healthyleuk.csv')